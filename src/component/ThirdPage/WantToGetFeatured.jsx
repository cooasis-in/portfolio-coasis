        ...
        <div className="container mx-auto bg-[#2229FF] rounded-[20px]">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center space-y-6 sm:space-y-0 sm:space-x-10 pt-6 pb-12">
            <div className="flex items-center">
              <p className="text-[16px] sm:text-[20px] text-[#EEE8E2] ml-2 text-center max-w-[650px]">We love to see new design projects from Aspiring Designers, and we check every submission we get.</p>
            </div>
          </div>
